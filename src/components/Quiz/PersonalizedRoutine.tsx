          ...
          {routineSections.map((section, index) => (
            ...
            >
              <div className="mx-auto flex w-full flex-col py-px max-md:mt-8 max-md:max-w-full">
                <div className="flex w-[180px] max-w-full gap-2">
                  <div className="flex min-h-[20px] items-center justify-center self-start overflow-hidden">
                    <img
                      loading="lazy"
                      src={section.icon}
                      className="my-auto aspect-square w-5 self-stretch object-contain"
                      alt=""
                    />
                  </div>
                  ...
                  {section.steps.map((step, stepIndex) => (
                    ...
                    >
                      ...
                      <div className="flex flex-col pb-2 pt-0.5 leading-none">
                        ...
                        <div className="mt-3 self-start text-sm">
                          {step.duration}
                        </div>
                      </div>
                    </div>
      ...
      <div className="mt-8 flex w-full flex-col justify-center rounded-lg bg-orange-50 p-4 text-sm leading-none text-black max-md:max-w-full">
        <div className="flex flex-wrap gap-10 max-md:max-w-full">
          ...
          <div className="flex flex-1 flex-col pb-2.5">
            <div>Estimated Budget: $200-300</div>
            <div className="mt-1.5 self-start">Products Needed: 6</div>
          </div>
        </div>
      </div>
    </div>
