...
// Add these loading states that will be used in QuizPage
export const quizCompletionStates: LoadingState[] = [
  { text: 'Analyzing your skin profile...' },
  { text: 'Finding matching ingredients...' },
  { text: 'Curating personalized product recommendations...' },
  { text: 'Preparing your customized skincare routine...' }
]
