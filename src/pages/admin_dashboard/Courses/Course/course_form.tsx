...
// @ts-nocheck
import { Form, Input, Button, message, ConfigProvider, Select, Upload, Table, Dropdown, Modal, Tooltip } from "antd";
...
import { UploadOutlined, EditOutlined, DeleteOutlined, EllipsisOutlined, PlusOutlined } from "@ant-design/icons";
...
export default function CourseForm() {
  ...
  const [expandedSections, setExpandedSections] = useState<Record<string, SectionDto>>({});
    ...
    Modal.confirm({
      ...
      onOk: async () => {
        try {
          ...
          // Refresh sections
          const updatedSections = sections.filter(s => s.sectionId !== sectionId);
  ...
  return (
    ...
    >
            ...
            <div className="space-y-6">
              ...
              <div>
                <Skeleton.Input
                  active={true}
                  block
                  className="!bg-[#31383d] !w-32 !h-6 mb-2"
                />
              ...
              <div className="flex justify-end gap-4">
                <Skeleton.Button
                  active={true}
                  className="!bg-[#31383d] rounded-md !w-20"
                />
                <Skeleton.Button
                  active={true}
                  className="!bg-[#31383d] rounded-md !w-20"
      ...
      {id && ( // Only show sections if editing an existing course
        <div className="mt-8 bg-[#282d35] p-6 rounded-lg">
